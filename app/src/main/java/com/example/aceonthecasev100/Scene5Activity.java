...
public class Scene5Activity extends AppCompatActivity implements Cutscene {
    ...
    public  int[] acesdialog = {3,4,6,7,16};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdialogues = getResources().getStringArray(R.array.array_of_dialogues_scene5);
        initText();
    ...
    {
        Intent intent = new Intent(this, Scene6Activity.class);
