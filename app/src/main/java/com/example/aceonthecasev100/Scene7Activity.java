...
public class Scene7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public  int[] acesdialog = {0,2,3,4,5,6,8,9,14};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdialogues = getResources().getStringArray(R.array.array_of_dialogues_scene7);
        initText();
        ...
        switch (view.getId()) {
            case R.id.nextBtn: {
                if( dialogueCounter < mdialogues.length) {
                    ...
                    Intent intent = new Intent(this, Scene8Activity.class);
