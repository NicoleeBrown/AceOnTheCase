...
public class Scene3Activity extends AppCompatActivity implements Cutscene {
    ...
    public  int[] acesdialog = { 0,1,2,4,5,11,12};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdialogues = getResources().getStringArray(R.array.array_of_dialogues_scene3);
        initText();
